 ...
 <div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
	...
	<div class="single-portfolio-summary col-lg-4 col-md-4 col-sm-4 col-xs-12">
		<div class="single-portfolio-des">
			<h3>Project Short Decscription</h3>
			<?php print $node->body['und'][0]['summary']; ?>
		</div>
		<div class="single-portfolio-details">
			<h3>Project Details</h3>
			<ul class="portfolio-detail-list">
				<li><?php print render($content['field_portfolio_date']);?></li>
				<li><?php print render($content['field_portfolio_client']);?></li>
				<li><?php print render($content['field_portfolio_skills']);?></li>
				<li><?php print render($content['field_portfolio_categories']);?></li>
			</ul>
			<?php print render($content['field_portfolio_website']);?>
		</div>
	</div>
